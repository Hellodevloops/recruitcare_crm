...
export default function QuotationEdit({ quotation: initialQuotation, clients: initialClients }: Props) {
    ...
    const [quotation, setQuotation] = useState<Quotation>({
        ...
        tax_rate: initialQuotation?.tax_rate?.toString() || '18',
        discount: initialQuotation?.discount?.toString() || '0',
    ...
    const handleUpdateQuotation = async () => {
        ...
        try {
            ...
            const response = await axios.put(`/quotations/${quotation.id}`, payload);
            ...
            const backendErrors = error.response?.data?.errors || { general: 'Failed to update quotation: ' + (error.message || 'Unknown error') };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Quotation #${formatQuotationId(quotation.id)}`} />
            <div className="flex h-full flex-1 flex-col gap-4 p-4 md:p-6">
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight">Edit Quotation #{formatQuotationId(quotation.id)}</h2>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Modify the quotation details including client information and line items</CardDescription>
                    </CardHeader>
                    <CardContent>
